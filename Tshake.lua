...
os.execute('wget https://raw.githubusercontent.com/MELANOTEAM/Tshake/master/Tshake.lua')
os.execute('wget https://raw.githubusercontent.com/MELANOTEAM/Tshake/master/start.lua')
dofile('Tshake.lua')  
return false
end
...
if DevTshake(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MELANOTEAM/files_Tshake/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MELANOTEAM/files_Tshake/master/files_Tshake/"..file)
if res == 200 then
